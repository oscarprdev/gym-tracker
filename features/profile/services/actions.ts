...
import type { UpdateProfileState, ChangePasswordState, DeleteAccountState } from '@/features/profile/types';
import { revalidatePath } from 'next/cache';
import { redirect } from 'next/navigation';

export const updateProfileAction = protectedAction(
  async (session, prevState: UpdateProfileState | null, formData: FormData): Promise<UpdateProfileState> => {
...
export const changePasswordAction = protectedAction(
  async (session, prevState: ChangePasswordState | null, formData: FormData): Promise<ChangePasswordState> => {
...
export const deleteAccountAction = protectedAction(
  async (session, prevState: DeleteAccountState | null, formData: FormData): Promise<DeleteAccountState> => {
