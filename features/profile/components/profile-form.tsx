...
import { updateProfileAction } from '@/features/profile/services/actions';
...
export function ProfileForm({ user }: ProfileFormProps) {
  const [state, formAction, isPending] = useActionState(updateProfileAction, {} as UpdateProfileState);
